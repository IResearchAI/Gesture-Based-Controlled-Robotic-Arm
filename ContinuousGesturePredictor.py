...
def showStatistics(predictedClass, confidence):
    ...
    if predictedClass == 0:
        className = "Swing"
	servol.set_position(70)
	servor.set_position(10)
	servom.set_position(0)
	servoi.set_position(50)
	servot.set_position(100)
    elif predictedClass == 1:
        className = "Palm"
	servol.set_position(70)
	servor.set_position(140)
	servom.set_position(100)
	servoi.set_position(140)
	servot.set_position(100)
    elif predictedClass == 2:
        className = "Fist"
	servol.set_position(180)
	servor.set_position(10)
	servom.set_position(0)
	servoi.set_position(50)
	servot.set_position(0)
